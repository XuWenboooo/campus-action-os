...
Production mode rejects development identity headers for protected routes until a real identity provider is configured. Destructive document deletion and other externally meaningful actions require an explicit confirmation body; retries use scoped idempotency keys.
